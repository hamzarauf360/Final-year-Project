...
var BTree1 = function() {
  ...
  this.preorder = function(Root) {
    ...
    if (Root) {
      preorder_traversal.push(Root.getData());
...
function question_4() {
  ...
  var txt2 = document.createTextNode("What is the preorder traversal of this bst?(Enter comma separated values)");
  ...
  var element5 = document.getElementById("subm4");
  ...
  var root = b2.getRoot();
  b2.preorder(root);
  var element556 = document.getElementById("subm4");
  element556.appendChild(but111);

  document.getElementById("viewans4").addEventListener("click", function(e) {
    ...
    txta.maxLength = 5000;
    txta.id = "answerr";
    var element5555 = document.getElementById("ans4");
    element5555.appendChild(txta);
    var nums = ""
    var i = 0;
    for (i = 0; i < preorder_traversal.length; i++) {


      nums += preorder_traversal[i];
      nums += ','
  ...
  document.getElementById("subin").addEventListener("click", function(e) {
    ...
    if (preorder_traversal.length != parsed.length) {
      var get = localStorage.getItem("bst_performance");
      get = get - 5;
      localStorage.setItem("bst_performance", get);
      swal({
      ...
      for (j = 0; j < inputt.length; j++) {
        if (preorder_traversal[j] != parsed[j]) {
          //alert(preorder_traversal[j]);
          //alert(parsed[j]);
          flag = false;
        }
      }
