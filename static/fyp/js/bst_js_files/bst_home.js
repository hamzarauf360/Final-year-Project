...
function init() { //button hide after click and tutorial
  localStorage.setItem("graph_performance", 100);
  localStorage.setItem("bst_performance", 100);
  localStorage.setItem("queue_stack_performance", 100);
  ...
  document.getElementById("sub").addEventListener("click", function(e) {
    if (document.getElementById("rad1").checked) {
      ...
      //export {res};
      window.location.href = "http://127.0.0.1:8000/bst_module/bst_sim2/";
    } else {
      //  wrong++
      swal({
        ...
        if (val) {
          window.location.href = "http://127.0.0.1:8000/bst_module/bst_sim/";
        }
      });
      //  window.location.href = "http://127.0.0.1:8000/bst_module/bst_sim/";
