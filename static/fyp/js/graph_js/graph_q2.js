...
var Graph = function() {
  ...
  this.dfss = function(Root) {

    if (Root) {
      dfs.push(Root.getData());

      this.dfss(Root.left);
      this.dfss(Root.right);
    }
  };
...
function question_3() {
  ...
  var txt2 = document.createTextNode("What is the depth first search of this graph?(Enter comma separated values)");
